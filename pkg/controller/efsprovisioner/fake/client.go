...
// NewFakeClientWithSchemeAndTracker creates a new fake client with the given scheme
// for testing.
func NewFakeClientWithSchemeAndTracker(clientScheme *runtime.Scheme, tracker testing.ObjectTracker) client.Client {
	return &fakeClient{
		tracker: tracker,
		scheme:  clientScheme,
	}
